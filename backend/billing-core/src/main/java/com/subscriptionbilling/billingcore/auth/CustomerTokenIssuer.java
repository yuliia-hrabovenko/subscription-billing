 ...
 * model: v1 has exactly one role (ADR-0003, no admin role), and every authorization
 * decision beyond that role is a service-layer ownership check, not a token claim.
 */
@Component
