...
/**
 * Ties a Customer to a Plan and carries the lifecycle state. Transition behavior
 * (cancel/undoCancel/schedulePlanChange) is added by later tickets in this spec;
 * this entity is the persistence shape those methods will operate on.
 */
@Entity
