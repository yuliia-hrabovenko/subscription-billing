 ...
 * (domain-model.md). Never mutated or deleted (Invariant 12). Attribution
 * (customer/system/gateway-initiated) is retrofitted by the audit spec's tickets;
 * {@code actor} here is a free-text placeholder those tickets narrow down.
 */
@Entity
